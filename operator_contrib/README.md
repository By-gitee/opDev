...
|------------------------------------------------------------|------------------------------------------| -- |---------------------|
| [AddcdivCustomSample](./AddcdivCustomSample)               | 基于Ascend C的Addcdiv自定义Vector算子及调用样例       | Atlas训练系列产品<br>Atlas 推理系列产品AI Core<br>Atlas A2训练系列产品<br>Atlas 200/500 A2 推理产品 | 8.0.RC1.alpha003及以上 |
...
| [AsStridedSample](./AsStridedSample)                       | 基于Ascend C的AsStrided自定义Vector算子及调用样例     | Atlas 200/500 A2 推理产品<br>Atlas A2训练系列产品/Atlas 800I A2推理产品 | 8.0.RC2.alpha003    |
...
| [CumsumSample](./CumsumSample)                             | 基于Ascend C的Cumsum自定义Vector算子及调用样例        | Atlas 200/500 A2 推理产品<br>Atlas A2训练系列产品/Atlas 800I A2推理产品 | 8.0.RC2.alpha003    |
| [DawsnSample](./DawsnSample)                               | 基于Ascend C的Dawsn自定义Vector算子及调用样例         | Atlas 200/500 A2 推理产品<br>Atlas A2训练系列产品/Atlas 800I A2推理产品 | 8.0.RC2.alpha003    |
| [EyeSample](./EyeSample)                                   | 基于Ascend C的Eye自定义Vector算子及调用样例           | Atlas 200/500 A2 推理产品<br>Atlas A2训练系列产品/Atlas 800I A2推理产品 | 8.0.RC2.alpha003    |
...
| [GeluSample](./GeluSample)                                 | 基于Ascend C的GeluSample自定义Vector算子及调用样例    | Atlas 200/500 A2 <br>Atlas A2训练系列产品/Atlas 800I A2推理产品 | 8.0.RC1.alpha003    |
| [FastGeluSample](./FastGeluSample)                         | 基于Ascend C的FastGelu自定义Vector算子及调用样例      | Atlas 200/500 A2 推理产品<br>Atlas A2训练系列产品/Atlas 800I A2推理产品 | 8.0.RC1.alpha003    |
| [FastGeluGradSample](./FastGeluGradSample)                 | 基于Ascend C的FastGeluGrad自定义Vector算子及调用样例  | Atlas 200/500 A2 推理产品<br>Atlas A2训练系列产品/Atlas 800I A2推理产品 | 8.0.RC1.alpha003    |
| [GeluSample](./GeluSample)                                 | 基于Ascend C的GeluSample自定义Vector算子及调用样例    | Atlas 200/500 A2 <br>Atlas A2训练系列产品/Atlas 800I A2推理产品 | 8.0.RC1.alpha003    |
| [GlobalAvgPoolSample](./GlobalAvgPoolSample)               | 基于Ascend C的GlobalAvgPool自定义Vector算子及调用样例 | Atlas 200/500 A2 推理产品<br>Atlas A2训练系列产品/Atlas 800I A2推理产品 | 8.0.RC2.alpha003    |
...
| [HistogramSample](./HistogramSample)                       | 基于Ascend C的Histogram自定义Vector算子及调用样例     | Atlas 200/500 A2 推理产品<br>Atlas A2训练系列产品/Atlas 800I A2推理产品 | 8.0.RC2.alpha003    |
...
| [LerpSample](./LerpSample)                                 | 基于Ascend C的Lerp自定义Vector算子及调用样例          | Atlas 200/500 A2 推理产品<br>Atlas A2训练系列产品/Atlas 800I A2推理产品 | 8.0.RC2.alpha003    |
...
| [QuantMatmulCustomSample](./QuantMatmulCustomSample)       | 基于AscendC的QuantMatmul自定义算子及调用样例          | Mate 70 Pro/Mate 70 Pro+/Mate 70 Pro RS/Mate X6                      | hwhiai-ddk-5.0.1.3  |
| [ReduceSumSample](./ReduceSumSample)                       | 基于Ascend C的ReduceSum自定义Vector算子及调用样例     | Atlas 200/500 A2 推理产品<br>Atlas A2训练系列产品/Atlas 800I A2推理产品 | 8.0.RC2.alpha003    |
...
| [ThreeNNSample](./ThreeNNSample)                           | 基于Ascend C的ThreeNN自定义Vector算子及调用样例       | Atlas 200/500 A2 推理产品<br>Atlas A2训练系列产品/Atlas 800I A2推理产品 | 8.0.RC2.alpha003    |
| [TrilSample](./TrilSample)                                 | 基于Ascend C的Tril自定义Vector算子及调用样例          | Atlas 200/500 A2 推理产品<br>Atlas A2训练系列产品/Atlas 800I A2推理产品 | 8.0.RC2.alpha003    |
| [TriuSample](./TriuSample)                                 | 基于Ascend C的Triu自定义Vector算子及调用样例          | Atlas 200/500 A2 推理产品<br>Atlas A2训练系列产品/Atlas 800I A2推理产品 | 8.0.RC2.alpha003    |
| [XlogySample](./XlogySample)                               | 基于Ascend C的Xlogy自定义Vector算子及调用样例         | Atlas 200/500 A2 推理产品<br>Atlas A2训练系列产品/Atlas 800I A2推理产品 | 8.0.RC2.alpha003    |
