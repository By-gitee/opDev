...
#ifndef GE_OP_SPARSE_MAT_MUL_T_GATHER_CSR_H
#define GE_OP_SPARSE_MAT_MUL_T_GATHER_CSR_H
#include "graph/operator_reg.h"
namespace ge {

REG_OP(SparseMatMulTGatherCSR)
    ...
    .OP_END_FACTORY_REG(SparseMatMulTGatherCSR)
}
#endif //GE_OP_SPARSE_MAT_MUL_T_GATHER_CSR_H
