...
#ifndef GE_OP_SPARSE_MAT_MUL_BASE_A_H
#define GE_OP_SPARSE_MAT_MUL_BASE_A_H
#include "graph/operator_reg.h"
namespace ge {

REG_OP(SparseMatMulTBaseA)
    ...
    .OP_END_FACTORY_REG(SparseMatMulTBaseA)
}
#endif //GE_OP_SPARSE_MAT_MUL_BASE_A_H
