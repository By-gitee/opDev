...
#ifndef GE_OP_SPARSE_MAT_MUL_BASE_B_H
#define GE_OP_SPARSE_MAT_MUL_BASE_B_H
#include "graph/operator_reg.h"
namespace ge {

REG_OP(SparseMatMulTBaseB)
    ...
    .OP_END_FACTORY_REG(SparseMatMulTBaseB)
}
#endif //GE_OP_SPARSE_MAT_MUL_BASE_B_H
