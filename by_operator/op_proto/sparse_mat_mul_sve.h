...
#ifndef GE_OP_SPARSE_MAT_MUL_SVE_H
#define GE_OP_SPARSE_MAT_MUL_SVE_H
#include "graph/operator_reg.h"
namespace ge {

REG_OP(SparseMatMulTBaseSVE)
    ...
    .OP_END_FACTORY_REG(SparseMatMulTBaseSVE)
}
#endif //GE_OP_SPARSE_MAT_MUL_SVE_H
