 ...
 * Description: api of SparseMatMulTBase
 */

#ifndef _SPARSE_MAT_MUL_BASE_KERNELS_H_
#define _SPARSE_MAT_MUL_BASE_KERNELS_H_

#include "cpu_kernel.h"
#include "eigen3/Eigen/Dense"
namespace aicpu {
class SparseMatMulTBaseCpuKernel : public CpuKernel {
public:
    ~SparseMatMulTBaseCpuKernel() = default;
